...
##### Conclusion
Manual transmission does have an increase of overall mpg performance of 1.80 mpg over automatic transmission, but only when including additional predictor variables to the model that are: cylinder number, horse power and car weight. The variable transmission alone is not sufficient to explain mpg efficiency.
